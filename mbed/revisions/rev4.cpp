...
Mutex stdio_mutex; // Setup mutex
Speaker myspeaker(p22); // Setup speaker
...
void fallInterrupt(){
    ...
    if ((hold0 == 1) && (hold1 == 1)&& (hold2 == 1) && (hold3 == 1)) {
        led1 = 1; 
        armed = false;
        myspeaker.PlayNote(523.25, 0.25, 0.5); //C
        myspeaker.PlayNote(659.25, 0.25, 0.5); //E
        myspeaker.PlayNote(783.99, 0.25, 0.5); //G
    }
}
